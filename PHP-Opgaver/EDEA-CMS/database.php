...
class database
{
     ...
     * 
     * @return bool true if succesful and false if delete failed
     */
    ...
    /**
     * Function to update row in MySQL Databas
     * 
     * @param string $table Table to update data in
     * @param array $array Multidimensonal array with KEY = column and VALUE = update value
     * @param string $where MySQL WHERE Value (E.g. ID = '1')
     * 
     * @return true if succesful and false if delete failed
     */
